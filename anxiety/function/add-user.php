...
if ($q > 0) {
    ...
    $query = mysqli_query($conn, "INSERT INTO `tb_user` (`userid`, `extplayer`, `user`, `pass`, `token_id`, `image`, `full_name`, `email`, `no_hp`, `level`, `pinTrx`, `reff`, `uplineID`, `join_date`, `last_login`, `status`) VALUES ('$useridd', '', '$user', '$pass', '0', 'avatar.webp', '$full_name', '$email', '$no_hp', '$level', '', 0, 1, '$join_date', '$join_date', 1)") or die(mysqli_error($conn));
