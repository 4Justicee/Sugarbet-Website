                  ...
                  <div class="card-datatable table-responsive">
                    <table class="invoice-list-table table border-top">
                      ...
                      <tbody>
                        ...
                        $sql_1 = mysqli_query($conn, "SELECT * FROM `tb_pasaran_result` WHERE pid = '$pid' AND periode = '$periode' ORDER BY gameid ASC") or die(mysqli_error($conn));
                        $no = 0;
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?= $s1['p_result']; ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?= $s1['posisi']; ?></td>
                          </tr>
                        <?php endwhile; ?>
                      </tbody>
                    </table>
