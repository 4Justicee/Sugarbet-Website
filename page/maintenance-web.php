...
$date = date('Y-m-d');
$stat = mysqli_query($conn, "INSERT INTO `tb_stat` (`ip`, `date`, `hits`, `page`, `user`) VALUES ('$ip', '$date', 1, 'Maintenance Web', '$pengguna')") or die(mysqli_error($conn));
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 text-center">
            ...
            <h4>Mohon maaf, saat ini kami sedang maintenance di server pusat, ini biasa terjadi kisaran 15 menit, silakan dicoba kembali beberapa menit kedepan, terima kasih :)</h4>
          </div>
          <div class="col-sm-3"></div>
        </div>
      </div>
