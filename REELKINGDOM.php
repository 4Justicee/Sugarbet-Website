  ...
  <div id="wrapper">
    ...
    <div class="bg-custom pb-5">
      <div class="container">
        <div class="row">
          <?php
          $sql_3 = mysqli_query($conn, "SELECT * FROM `tb_gamenew` WHERE `game_provider` = 'REELKINGDOM' ORDER BY RAND() LIMIT 54") or die(mysqli_error($conn));
          ...
          ?>
            <div class="col-sm-2 col-4 text-center pt-0 p-2">
              <a href="<?= $playUrl; ?>">
                <img data-sizes="auto" data-src="<?= $urldomain; ?>/upload/game_pic/<?= $s3['game_provider']; ?>/<?= $s3['game_code']; ?>.png" src="<?= $urldomain; ?>/assets/images/loading.gif" class="lazyload shadow gamenormalimg" alt="Slot <?= $app_name; ?>">
