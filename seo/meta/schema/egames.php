...
<script type="application/ld+json">
  {
    ...
    "@id": "#WebPage",
    "url": "<?= $url; ?>",
    "name": "E Games - <?= $app_name; ?>",
    "alternateName": "E Games <?= $app_name; ?>",
    "headline": "E Games - <?= $app_name; ?>",
    "alternativeHeadline": "E Games <?= $app_name; ?>",
    "description": "E Games <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>",
    "disambiguatingDescription": "E Games - <?= $app_name; ?>. <?= $descalt; ?>",
    "abstract": "E Games <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>. <?= $descalt; ?>",
    "keywords": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "genre": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "thumbnailUrl": "<?= $urldomain; ?>/assets/images/pages/egames.webp",
    "primaryImageOfPage": {
      "@type": "ImageObject",
      "@id": "#ImageOfPage",
      "inLanguage": "ID",
      "contentUrl": "<?= $urldomain; ?>/assets/images/pages/egames.webp",
      "caption": "E Games - <?= $app_name; ?>"
    },
    "image": {
      "@type": "ImageObject",
      "@id": "#Image",
      ...
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/pages/egames.webp",
      "caption": "E Games - <?= $app_name; ?>"
    },
    "inLanguage": "ID",
...
<script type="application/ld+json">
  {
    ...
    "keywords": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "thumbnailUrl": "<?= $urldomain; ?>/assets/images/egames.webp",
    "image": {
      "@type": "ImageObject",
      "@id": "#Image",
      "inLanguage": "id",
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/egames.webp",
      "caption": "E Games"
    },
    "sameAs": ["<?= $s1a['facebook']; ?>", "<?= $s1a['twitter']; ?>", "<?= $s1a['instagram']; ?>", "<?= $s1a['linkedin']; ?>", "<?= $s1a['youtube']; ?>"],
    "potentialAction": {
