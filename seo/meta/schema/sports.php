...
<script type="application/ld+json">
  {
    ...
    "@id": "#WebPage",
    "url": "<?= $url; ?>",
    "name": "Sports Games - <?= $app_name; ?>",
    "alternateName": "Sports Games <?= $app_name; ?>",
    "headline": "Sports Games - <?= $app_name; ?>",
    "alternativeHeadline": "Sports Games <?= $app_name; ?>",
    "description": "Sports Games <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>",
    "disambiguatingDescription": "Sports Games - <?= $app_name; ?>. <?= $descalt; ?>",
    "abstract": "Sports Games <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>. <?= $descalt; ?>",
    "keywords": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "genre": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "thumbnailUrl": "<?= $urldomain; ?>/assets/images/pages/sports.webp",
    "primaryImageOfPage": {
      "@type": "ImageObject",
      "@id": "#ImageOfPage",
      "inLanguage": "ID",
      "contentUrl": "<?= $urldomain; ?>/assets/images/pages/sports.webp",
      "caption": "Sports Games - <?= $app_name; ?>"
    },
    "image": {
      "@type": "ImageObject",
      "@id": "#Image",
      ...
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/pages/sports.webp",
      "caption": "Sports Games - <?= $app_name; ?>"
    },
    "inLanguage": "ID",
...
<script type="application/ld+json">
  {
    ...
    "keywords": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "thumbnailUrl": "<?= $urldomain; ?>/assets/images/sports.webp",
    "image": {
      "@type": "ImageObject",
      "@id": "#Image",
      "inLanguage": "id",
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/sports.webp",
