...
<script type="application/ld+json">
  {
    ...
    "@id": "#WebPage",
    "url": "<?= $url; ?>",
    "name": "Slot Ante Bonus - <?= $app_name; ?>",
    "alternateName": "Slot Ante Bonus <?= $app_name; ?>",
    "headline": "Slot Ante Bonus - <?= $app_name; ?>",
    "alternativeHeadline": "Slot Ante Bonus <?= $app_name; ?>",
    "description": "Slot Ante Bonus <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>",
    "disambiguatingDescription": "Slot Ante Bonus - <?= $app_name; ?>. <?= $descalt; ?>",
    "abstract": "Slot Ante Bonus <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>. <?= $descalt; ?>",
    "keywords": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "genre": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "thumbnailUrl": "<?= $urldomain; ?>/assets/images/pages/ante-bonus-slot.webp",
    "primaryImageOfPage": {
      "@type": "ImageObject",
      "@id": "#ImageOfPage",
      "inLanguage": "ID",
      "contentUrl": "<?= $urldomain; ?>/assets/images/pages/ante-bonus-slot.webp",
      "caption": "Slot Ante Bonus - <?= $app_name; ?>"
    },
    "image": {
      "@type": "ImageObject",
      "@id": "#Image",
      ...
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/pages/ante-bonus-slot.webp",
      "caption": "Slot Ante Bonus - <?= $app_name; ?>"
    },
    "inLanguage": "ID",
...
<script type="application/ld+json">
  {
    ...
    "image": {
      ...
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/ante-bonus-slot.webp",
      "caption": "Slot Ante Bonus"
    },
    "sameAs": ["<?= $s1a['facebook']; ?>", "<?= $s1a['twitter']; ?>", "<?= $s1a['instagram']; ?>", "<?= $s1a['linkedin']; ?>", "<?= $s1a['youtube']; ?>"],
    "potentialAction": {
      "@type": "ReadAction",
