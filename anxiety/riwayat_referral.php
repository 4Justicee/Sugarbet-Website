        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Transaction /</span> Riwayat Bonus Referral
            </h4>
            <!-- Invoice List Table -->
            <?php
                ...
                <table id="default-datatable" class="invoice-list-table table border-top">
                  <thead>
                    <tr class="bg-primary">
                      ...
                      <th class="text-center" style="vertical-align: middle;">Referral</th>
                  ...
                  <tbody>
                    <?php
                    $sql_1 = mysqli_query($conn, "SELECT * FROM `tb_transaksi` WHERE jenis = 3 AND userID NOT IN (1,2) AND `date` LIKE '$today%' ORDER BY cuid DESC") or die(mysqli_error($conn));
                    $no = 0;
                    while ($s1 = mysqli_fetch_array($sql_1)) :
                      ...
                      $sql_4 = mysqli_query($conn, "SELECT * FROM `tb_user` WHERE cuid = '$IDuserreff'") or die(mysqli_error($conn));
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?= $s4['user']; ?></td>
                        <td class="text-right" style="vertical-align: middle; white-space: normal; font-size: 14px; text-align: right;"><?= number_format($s1['total'], 0, ",", "."); ?></td>
