...
<script type="application/ld+json">
  {
    ...
    "@id": "#WebPage",
    "url": "<?= $url; ?>",
    "name": "Slot Lainnya - <?= $app_name; ?>",
    "alternateName": "Slot Lainnya <?= $app_name; ?>",
    "headline": "Slot Lainnya - <?= $app_name; ?>",
    "alternativeHeadline": "Slot Lainnya <?= $app_name; ?>",
    "description": "Slot Lainnya <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>",
    "disambiguatingDescription": "Slot Lainnya - <?= $app_name; ?>. <?= $descalt; ?>",
    "abstract": "Slot Lainnya <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>. <?= $descalt; ?>",
    "keywords": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "genre": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "thumbnailUrl": "<?= $urldomain; ?>/assets/images/pages/slot-lainnya.webp",
    "primaryImageOfPage": {
      "@type": "ImageObject",
      "@id": "#ImageOfPage",
      "inLanguage": "ID",
      "contentUrl": "<?= $urldomain; ?>/assets/images/pages/slot-lainnya.webp",
      "caption": "Slot Lainnya - <?= $app_name; ?>"
    },
    "image": {
      "@type": "ImageObject",
      "@id": "#Image",
      ...
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/pages/slot-lainnya.webp",
      "caption": "Slot Lainnya - <?= $app_name; ?>"
    },
    "inLanguage": "ID",
...
<script type="application/ld+json">
  {
    ...
    "keywords": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "thumbnailUrl": "<?= $urldomain; ?>/assets/images/slot-lainnya.webp",
    "image": {
      "@type": "ImageObject",
      "@id": "#Image",
      "inLanguage": "id",
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/slot-lainnya.webp",
      "caption": "Slot Lainnya"
    },
    "sameAs": ["<?= $s1a['facebook']; ?>", "<?= $s1a['twitter']; ?>", "<?= $s1a['instagram']; ?>", "<?= $s1a['linkedin']; ?>", "<?= $s1a['youtube']; ?>"],
    "potentialAction": {
      "@type": "ReadAction",
