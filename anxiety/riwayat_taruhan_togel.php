        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Transaction /</span> Riwayat Togel Betting
            </h4>
            <!-- Invoice List Table -->
            <?php
            ...
            <div class="card">
              <div class="card-datatable table-responsive">
                <table id="default-datatable" class="invoice-list-table table border-top">
                  ...
                  <tbody>
                    <?php
                    $sql_1 = mysqli_query($conn, "SELECT * FROM `tb_transaksi` WHERE jenis = 9 AND userID NOT IN (1,2) AND `date` LIKE '$today%' ORDER BY cuid DESC") or die(mysqli_error($conn));
                    $no = 0;
