(function (global, factory) {
    ...
    var da_DK = {
        base64: {
            default: 'Udfyld venligst dette felt med en gyldig base64-kodet v  rdi',
        },
        between: {
            default: 'Udfyld venligst dette felt med en v  rdi mellem %s og %s',
            notInclusive: 'Indtast venligst kun en v  rdi mellem %s og %s',
        },
        bic: {
            default: 'Udfyld venligst dette felt med et gyldigt BIC-nummer',
        },
        callback: {
            default: 'Udfyld venligst dette felt med en gyldig v  rdi',
        },
        choice: {
            between: 'V  lg venligst %s - %s valgmuligheder',
            default: 'Udfyld venligst dette felt med en gyldig v  rdi',
            less: 'V  lg venligst mindst %s valgmuligheder',
            more: 'V  lg venligst h  jst %s valgmuligheder',
        },
        color: {
        ...
        date: {
            ...
            max: 'Angiv venligst en dato f  r %s',
            min: 'Angiv venligst en dato efter %s',
            range: 'Angiv venligst en dato mellem %s - %s',
        },
        different: {
            default: 'Udfyld venligst dette felt med en anden v  rdi',
        },
        digits: {
        ...
        file: {
            default: 'V  lg venligst en gyldig fil',
        },
        greaterThan: {
            default: 'Udfyld venligst dette felt med en v  rdi st  rre eller lig med %s',
            notInclusive: 'Udfyld venligst dette felt med en v  rdi st  rre end %s',
        },
        grid: {
        ...
        identical: {
            default: 'Udfyld venligst dette felt med den samme v  rdi',
        },
        imei: {
        ...
        lessThan: {
            default: 'Udfyld venligst dette felt med en v  rdi mindre eller lig med %s',
            notInclusive: 'Udfyld venligst dette felt med en v  rdi mindre end %s',
        },
        mac: {
        ...
        regexp: {
            default: 'Udfyld venligst dette felt med en v  rdi der matcher m  nsteret',
        },
        remote: {
            default: 'Udfyld venligst dette felt med en gyldig v  rdi',
        },
        ...
        stringCase: {
            default: 'Udfyld venligst kun dette felt med sm   bogstaver',
            upper: 'Udfyld venligst kun dette felt med store bogstaver',
        },
        stringLength: {
            between: 'Udfyld venligst dette felt med en v  rdi mellem %s og %s tegn',
            default: 'Udfyld venligst dette felt med en v  rdi af gyldig l  ngde',
