        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Information /</span> <span class="text-muted fw-light">Togel /</span> Result
            </h4>
            <div class="row">
              <div class="col-sm-12">
                <!-- Invoice List Table -->
                  ...
                  <div class="card-datatable table-responsive">
                    <table id="default-datatable" class="invoice-list-table table border-top">
                      ...
                      <tbody>
                        <?php
                        $pid = $_GET['pid'];
                        $sql_11 = mysqli_query($conn, "SELECT * FROM `tb_pasaran` WHERE cuid = '$pid'") or die(mysqli_error($conn));
                        $s11 = mysqli_fetch_array($sql_11);
                        $sql_1 = mysqli_query($conn, "SELECT * FROM `tb_periode` WHERE pid = '$pid' ORDER BY cuid ASC") or die(mysqli_error($conn));
                        $no = 0;
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-left" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?= $s11['title']; ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?= $s1['no']; ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?= $s1['created']; ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?= $s1['result']; ?></td>
                            <td class="text-center" style="vertical-align: middle; white-space: normal; font-size: 14px;">
                              <a href="<?= $urladmin; ?>/detail_result/?pid=<?= $pid; ?>&periode=<?= $s1['no']; ?>" class="btn btn-success btn-sm">Detail</a>
                            </td>
                          </tr>
                        <?php endwhile; ?>
                      </tbody>
