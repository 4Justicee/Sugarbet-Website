...
<script type="application/ld+json">
  {
    ...
    "@id": "#WebPage",
    "url": "<?= $url; ?>",
    "name": "RTP Slot Games - <?= $app_name; ?>",
    "alternateName": "RTP Slot Games <?= $app_name; ?>",
    "headline": "RTP Slot Games - <?= $app_name; ?>",
    "alternativeHeadline": "RTP Slot Games <?= $app_name; ?>",
    "description": "RTP Slot Games <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>",
    "disambiguatingDescription": "RTP Slot Games - <?= $app_name; ?>. <?= $descalt; ?>",
    "abstract": "RTP Slot Games <?= $app_name; ?>. <?= $s0['instansi']; ?> <?= $slogan; ?>. <?= $s0['deskripsi']; ?>. <?= $descalt; ?>",
    "keywords": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "genre": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "thumbnailUrl": "<?= $urldomain; ?>/assets/images/pages/rtp-slot.webp",
    "primaryImageOfPage": {
      "@type": "ImageObject",
      "@id": "#ImageOfPage",
      "inLanguage": "ID",
      "contentUrl": "<?= $urldomain; ?>/assets/images/pages/rtp-slot.webp",
      "caption": "RTP Slot Games - <?= $app_name; ?>"
    },
    "image": {
      "@type": "ImageObject",
      "@id": "#Image",
      ...
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/pages/rtp-slot.webp",
      "caption": "RTP Slot Games - <?= $app_name; ?>"
    },
    "inLanguage": "ID",
...
<script type="application/ld+json">
  {
    ...
    "keywords": ["<?= str_replace(',', '","', $s0['keyword']); ?>"],
    "thumbnailUrl": "<?= $urldomain; ?>/assets/images/rtp-slot.webp",
    "image": {
      "@type": "ImageObject",
      "@id": "#Image",
      "inLanguage": "id",
      "width": 1920,
      "height": 1080,
      "url": "<?= $urldomain; ?>/assets/images/rtp-slot.webp",
      "caption": "RTP Slot Games"
    },
    "sameAs": ["<?= $s1a['facebook']; ?>", "<?= $s1a['twitter']; ?>", "<?= $s1a['instagram']; ?>", "<?= $s1a['linkedin']; ?>", "<?= $s1a['youtube']; ?>"],
    "potentialAction": {
      "@type": "ReadAction",
