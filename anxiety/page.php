                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    if (isset($_GET['postID'])) {
                      $catID = $_GET['postID'];
                      $sql_2 = mysqli_query($conn, "SELECT * FROM `tb_page` WHERE cuid = '$catID'") or die(mysqli_error($conn));
                      $s2 = mysqli_fetch_array($sql_2);
                    }
                    ?>
                    <form role="form" action="<?= $urladmin; ?>/function/edit-page.php" method="post" enctype="multipart/form-data">
                      ...
                      <a href="<?= $urladmin; ?>/page/" class="btn btn-light">Cancel</a>
                    </form>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-datatable table-responsive">
                    <table id="default-datatable" class="invoice-list-table table border-top">
                      ...
                      <tbody>
                        <?php
                        $sql_1 = mysqli_query($conn, "SELECT * FROM `tb_page` ORDER BY cuid ASC") or die(mysqli_error($conn));
                        $no = 0;
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-left" style="vertical-align: middle; white-space: normal; font-size: 14px;"><?= $s1['nama_page']; ?></td>
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?= $urladmin; ?>/page/?postID=<?= $s1['cuid']; ?>" class="btn btn-primary btn-sm">
                                <i class="fa fa-edit"></i>
                              </a>
                              <a href="<?= $urladmin; ?>/function/del-page.php?cuid=<?= $s1['cuid']; ?>&jenis=1" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');">
