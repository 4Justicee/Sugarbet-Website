        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Pengaturan /</span> Social Media
            </h4>
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    $sql_2 = mysqli_query($conn, "SELECT * FROM `tb_social` WHERE cuid = 1") or die(mysqli_error($conn));
                    $s2 = mysqli_fetch_array($sql_2);
                    ?>
                    <form role="form" action="<?= $urladmin; ?>/function/social.php" method="post" enctype="multipart/form-data">
                      <div class="form-group mb-2">
                        <label class="form-label">Facebook :</label>
                        <input type="text" class="form-control" name="facebook" value="<?= $s2['facebook']; ?>" required>
                      </div>
                      <div class="form-group mb-2">
                        <label class="form-label">Twitter :</label>
                        <input type="text" class="form-control" name="twitter" value="<?= $s2['twitter']; ?>" required>
                      </div>
                      <div class="form-group mb-2">
                        <label class="form-label">Instagram :</label>
                        <input type="text" class="form-control" name="instagram" value="<?= $s2['instagram']; ?>" required>
                      </div>
                      <div class="form-group mb-2">
                        <label class="form-label">Linkedin :</label>
                        <input type="text" class="form-control" name="linkedin" value="<?= $s2['linkedin']; ?>" required>
                      </div>
                      <div class="form-group mb-2">
                        <label class="form-label">Youtube :</label>
                        <input type="text" class="form-control" name="youtube" value="<?= $s2['youtube']; ?>" required>
                      </div>
