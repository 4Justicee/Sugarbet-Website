(function (global, factory) {
    ...
    var fr_BE = {
        base64: {
            default: 'Veuillez fournir une donn  e correctement encod  e en Base64',
        },
        between: {
        ...
        creditCard: {
            default: 'Veuillez fournir un num  ro de carte de cr  dit valide',
        },
        cusip: {
        ...
        date: {
            ...
            max: 'Veuillez fournir une date inf  rieure    %s',
            min: 'Veuillez fournir une date sup  rieure    %s',
            range: 'Veuillez fournir une date comprise entre %s et %s',
        },
        different: {
            default: 'Veuillez fournir une valeur diff  rente',
        },
        digits: {
        ...
        greaterThan: {
            default: 'Veuillez fournir une valeur sup  rieure ou   gale    %s',
            notInclusive: 'Veuillez fournir une valeur sup  rieure    %s',
        },
        grid: {
            default: 'Veuillez fournir un code GRId valide',
        },
        hex: {
            default: 'Veuillez fournir un nombre hexad  cimal valide',
        },
        iban: {
            countries: {
                AD: 'Andorre',
        ...
        id: {
            ...
            country: "Veuillez fournir un num  ro d'identification valide pour %s",
            default: "Veuillez fournir un num  ro d'identification valide",
        },
        identical: {
            default: 'Veuillez fournir la m  me valeur',
        },
        imei: {
        ...
        lessThan: {
            default: 'Veuillez fournir une valeur inf  rieure ou   gale    %s',
            notInclusive: 'Veuillez fournir une valeur inf  rieure    %s',
        },
        mac: {
        ...
        numeric: {
            default: 'Veuillez fournir une valeur d  cimale valide',
        },
        phone: {
            countries: {
                AE: '  mirats Arabes Unis',
            ...
            country: 'Veuillez fournir un num  ro de t  l  phone valide pour %s',
            default: 'Veuillez fournir un num  ro de t  l  phone valide',
        },
        promise: {
            default: 'Veuillez fournir une valeur valide',
        },
        regexp: {
            default: 'Veuillez fournir une valeur correspondant au mod  le',
        },
        remote: {
            default: 'Veuillez fournir une valeur valide',
        },
        ...
        siren: {
            default: 'Veuillez fournir un num  ro SIREN valide',
        },
        siret: {
            default: 'Veuillez fournir un num  ro SIRET valide',
        },
        step: {
            default: 'Veuillez fournir un   cart valide de %s',
        },
        stringCase: {
            default: 'Veuillez ne fournir que des caract  res minuscules',
            upper: 'Veuillez ne fournir que des caract  res majuscules',
        },
        stringLength: {
            between: 'Veuillez fournir entre %s et %s caract  res',
            default: 'Veuillez fournir une valeur de longueur valide',
            less: 'Veuillez fournir moins de %s caract  res',
            more: 'Veuillez fournir plus de %s caract  res',
        },
        uri: {
