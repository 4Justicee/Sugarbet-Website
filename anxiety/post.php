        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Information /</span> Blog
            </h4>
            <div class="row">
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                      ...
                      if ($_GET['notif'] == 1) {
                        echo '
                              <div class="alert alert-success d-flex align-items-center" role="alert">
                                ...
                                <span><strong>Well Done!</strong> Blog Saved!</span>
                              </div>
                            ';
                      }
                      if ($_GET['notif'] == 2) {
                    ...
                    ?>
                    <form role="form" action="<?= $urladmin; ?>/function/add-post.php" method="post" enctype="multipart/form-data">
                      ...
                      <a href="<?= $urladmin; ?>/post/" class="btn btn-light">Cancel</a>
                    </form>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  <div class="card-datatable table-responsive">
                    <table id="default-datatable" class="invoice-list-table table border-top">
                      ...
                      <tbody>
                        <?php
                        $sql_1 = mysqli_query($conn, "SELECT * FROM `tb_post` WHERE kategori = 0 ORDER BY cuid ASC") or die(mysqli_error($conn));
                        $no = 0;
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle; font-size: 14px;">
                              <a href="<?= $urladmin; ?>/post/?postID=<?= $s1['cuid']; ?>" class="btn btn-primary btn-sm">
                                <i class="fa fa-edit"></i>
                              </a>
                              <a href="<?= $urladmin; ?>/function/del-post.php?cuid=<?= $s1['cuid']; ?>&jenis=0" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want remove this data?');">
