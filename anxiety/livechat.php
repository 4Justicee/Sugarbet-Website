        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Pengaturan /</span> Live Chat
            </h4>
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                      ...
                      if ($_GET['notif'] == 1) {
                        echo '
                              <div class="alert alert-success d-flex align-items-center" role="alert">
                                ...
                                <span><strong>Well Done!</strong> Live Chat Saved!</span>
                              </div>
                            ';
                      }
                    }
                    $sql_2 = mysqli_query($conn, "SELECT * FROM `tb_livechat` WHERE cuid = 1") or die(mysqli_error($conn));
                    $s2 = mysqli_fetch_array($sql_2);
                    ?>
                    <form role="form" action="<?= $urladmin; ?>/function/livechat.php" method="post" enctype="multipart/form-data">
                      <div class="form-group mb-2">
                        <b>Desktop dan tablet</b>
                        <p>LiveChat JS :</p>
                        <textarea type="text" class="form-control summernoteEditor" name="lc_js" rows="3"><?= $s2['lc_js']; ?></textarea>
                      </div>
                      <div class="form-group mb-4">
                        <p>Alternatif: jika <b>Error</b> saat disimpan, masukkan code javascript pada file <b>partials/extra_footer_code.php</b> secara manual.</p>
                      </div>
                      <div class="form-group mb-2">
                        <b>Perangkat mobile</b>
                        <p>Link Livechat :</p>
                        <input type="text" class="form-control" name="lc_mobile" value="<?= $s2['lc_mobile']; ?>" placeholder="https://m.me/<?= str_replace(" ", "", $app_name); ?> or https://wa.me/628 or https://t.me/628, dll" required>
                      </div>
