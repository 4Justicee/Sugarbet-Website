...
<head>
  ...
  <?php include('../seo/meta/member-slot.php'); ?>
            ...
            <div class="card">
              <div class="card-header p-0">
                <ul class="nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="<?= $urldomain; ?>/history-slot"><i class="fa fa-gamepad" style="width: 20px; color: <?= $s0['warnadasar']; ?>;"></i> Gameplay</a>
                  </li>
                  <li class="nav-item">
              ...
              <?php if ($userLevel == 'user') { ?>
                <div class="card-body py-3 px-3">
                  <div class="mt-3 mb-3 bg-primary" style="padding: 20px 10px;">
                    <h5 class="text-white mb-0">Riwayat Gameplay</h5>
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    $sql_transaksi = mysqli_query($conn, "SELECT * FROM `tb_transaksi` WHERE userID = '$IDuser' AND jenis IN(5,6,9) ORDER BY cuid DESC LIMIT 10") or die(mysqli_error($conn));
                      ...
                      <li class="list-group-item mb-2">
                        <div class="row align-items-center" style="padding-top: 15px;">
                          ...
                          <div class="col-auto text-right">
                            ...
                            <?php
                            if ($st['jenis'] == 5 || $st['jenis'] == 6 || $st['jenis'] == 9) {
                              if ($st['status'] == 0) {
                                echo '
                              <a href="#" class="badge badge-primary p-2">Bayar</a>
                              ';
                              } else if ($st['status'] == 1) {
                                echo '
                  ...
                  $apanya = mysqli_query($conn, "SELECT * FROM `tb_transaksi` WHERE userID = '$IDuser' AND jenis IN(5,6,9) AND (`date` BETWEEN '$startWeek' AND '$startDay') ORDER BY cuid DESC") or die(mysqli_error($conn));
                  ...
                  ?>
                    <nav aria-label="Page navigation example">
                      <ul class="pagination justify-content-end">
                        ...
                        ?>
                          <li class="page-item<?= $link_active; ?>"><a class="page-link" href="<?= $urldomain; ?>/history-slot?page=<?= $i; ?>"><?= $i; ?></a></li>
                        <?php endfor; ?>
                      </ul>
                    </nav>
                  <?php endif; ?>
