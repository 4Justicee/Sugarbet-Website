(function (global, factory) {
    ...
    var sr_RS = {
        base64: {
            default: 'Molimo da unesete va  e  i base 64 enkodovan',
        },
        between: {
            default: 'Molimo da unesete vrednost izme  u %s i %s',
            notInclusive: 'Molimo da unesete vrednost strogo izme  u %s i %s',
        },
        bic: {
            default: 'Molimo da unesete ispravan BIC broj',
        },
        callback: {
            default: 'Molimo da unesete va  e  u vrednost',
        },
        choice: {
        ...
        emailAddress: {
            default: 'Molimo da unesete va  e  u e-mail adresu',
        },
        file: {
            default: 'Molimo da unesete ispravan fajl',
        },
        greaterThan: {
            default: 'Molimo da unesete vrednost ve  u ili jednaku od %s',
            notInclusive: 'Molimo da unesete vrednost ve  u od %s',
        },
        grid: {
        ...
        iban: {
            countries: {
                ...
                TN: 'Tunisa',
                TR: 'Turske',
                VG: 'Britanskih Devi  anskih Ostrva',
                XK: '                               ',
            },
        ...
        stringLength: {
            between: 'Molimo da unesete vrednost du  ine izme  u %s i %s karaktera',
            default: 'Molimo da unesete vrednost sa ispravnom du  inom',
            less: 'Molimo da unesete manje od %s karaktera',
            more: 'Molimo da unesete vi  e od %s karaktera',
        },
        uri: {
        ...
        zipCode: {
            ...
            country: 'Molimo da unesete ispravan po  tanski broj %s',
            default: 'Molimo da unesete ispravan po  tanski broj',
        },
    };
