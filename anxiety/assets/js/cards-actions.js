      ...
      setTimeout(function () {
        ...
        if ($this.closest('.card').find('.card-alert').length) {
          $this
            ...
            .find('.card-alert')
            .html(
              '<div class="alert alert-danger alert-dismissible mt-3 mb-3" role="alert"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Tutup Navigasi"></button><strong>Holy grail!</strong> Your success/error message here.</div>'
            );
        }
      }, 2500);
    });
