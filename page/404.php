...
$date = date('Y-m-d');
$stat = mysqli_query($conn, "INSERT INTO `tb_stat` (`ip`, `date`, `hits`, `page`, `user`) VALUES ('$ip', '$date', 1, '404', '$pengguna')") or die(mysqli_error($conn));
...
<head>
  ...
  <?php include('../seo/meta/private-404.php'); ?>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 text-center">
            ...
            <a href="<?= $urldomain; ?>" class="btn btn-danger">Kembali Ke Home</a>
          </div>
          <div class="col-sm-3"></div>
        </div>
      </div>
